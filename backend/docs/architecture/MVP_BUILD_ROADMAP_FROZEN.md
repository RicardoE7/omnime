...
- Cookie/domain/SameSite configuration compatible with the actual Vercel/Railway topology.
...
**Browser → Vercel → Railway Spring Boot → Railway PostgreSQL**
